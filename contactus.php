...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.icscent@gmail.com';
    $mail->Password   = 'vkmf wvss dcjd ddmr'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.icscent@gmail.com', 'ICSCENT Enquiry');
    $mail->addAddress('info.icscent@gmail.com', 'ICSCENT Enquiry');
    ...
    $replyMail->Username   = 'info.icscent@gmail.com';
    $replyMail->Password   = 'vkmf wvss dcjd ddmr';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icscent@gmail.com', 'ICSCENT Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICSCENT 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICSCENT 2025 Team</p>
        </div>
    ';
